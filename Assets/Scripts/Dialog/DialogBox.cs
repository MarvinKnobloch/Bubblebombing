...
public class DialogBox : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            {
                if (controls.Player.Interact.WasPerformedThisFrame() || controls.Player.LMB.WasPerformedThisFrame())
                {
                    DialogContinue();
                }
    ...
    private void DialogUpdate()
    {
        ...
        if (autoPlayInterval == 0)
        {
            ...
            continueText.text = "Continue (" + controls.Player.LMB.GetBindingDisplayString() + " or " + controls.Player.Interact.GetBindingDisplayString() + ")";
        }
